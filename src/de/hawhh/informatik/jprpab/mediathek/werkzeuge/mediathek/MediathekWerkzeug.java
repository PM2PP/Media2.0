package de.hawhh.informatik.jprpab.mediathek.werkzeuge.mediathek;
...
import de.hawhh.informatik.jprpab.mediathek.werkzeuge.ausleihe.AusleihWerkzeug;
import de.hawhh.informatik.jprpab.mediathek.werkzeuge.rueckgabe.RueckgabeWerkzeug;
...
public class MediathekWerkzeug
{
	 ...
	 */
	public MediathekWerkzeug(Stage primaryStage, MedienbestandService medienbestand, KundenstammService kundenstamm,
			VerleihService verleihService)
	{
		...
		_ausleihWerkzeug = new AusleihWerkzeug(_medienbestand, _kundenstamm, _verleihService);

		_rueckgabeWerkzeug = new RueckgabeWerkzeug(_verleihService);

		// Erzeuge UI für dieses Werkzeug
		_mediathekUI = new MediathekUI(primaryStage, _ausleihWerkzeug.getUIPane(), _rueckgabeWerkzeug.getUIPane());
